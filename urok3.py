...
class Human:
    ...
    def days_indexes(self, day):
        header = f" Today the {day} of {self.name}'s life "
        print(f"{header:=^50}\n")
        print(f"{self.name}'s indexes".center(50), "\n")
        print(f"Money – {self.money}")
        print(f"Satiety – {self.satiety}")
        print(f"Gladness – {self.gladness}")
        print(f"\n{'Home indexes'.center(50)}\n")
        if self.home:
            print(f"Food – {self.home.food}")
            print(f"Mess – {self.home.mess}")
        if self.car:
            print(f"\n{(self.car.brand + ' car indexes').center(50)}\n")
    ...
    def live(self, day):
        ...
        if self.satiety < 20:
            ...
            if self.home and self.home.mess > 15:
